...
const $LOVE_MESSAGE = document.querySelector('.love-message');

const showLoveMessage = () => {
  $LOVE_MESSAGE.classList.add('show');
  setTimeout(() => {
    $LOVE_MESSAGE.classList.remove('show');
  }, 2000); // el mensaje dura 2 segundos
};

$BEAR.addEventListener('mousedown', showLoveMessage);
$BEAR.addEventListener('touchstart', showLoveMessage);
